...
class compraController extends Controller
{
    ...
    {
        // Obtener el próximo número de comprobante de manera segura
        $ultimoNumero = Compra::max('numero_comprobante');
        $nextComprobanteNumber = $ultimoNumero ? (int)$ultimoNumero + 1 : 1;
        ...
        return view('compra.create', [
            ...
            'productos' => $productos,
            'nextComprobanteNumber' => str_pad($nextComprobanteNumber, 8, '0', STR_PAD_LEFT)
        ]);
    }
