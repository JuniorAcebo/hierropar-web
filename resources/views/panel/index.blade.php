...
@section('content')
    ...
    @php
        $cards = [
            ['variant' => 'kpi-primary', 'icon' => 'fa-people-group', 'title' => 'Clientes', 'count' => $metricas['totalClientes'], 'route' => route('clientes.index')],
            ['variant' => 'kpi-warning', 'icon' => 'fa-tags', 'title' => 'Categorías', 'count' => $metricas['totalCategorias'], 'route' => route('categorias.index')],
            ['variant' => 'kpi-success', 'icon' => 'fa-shopping-bag', 'title' => 'Compras', 'count' => $metricas['totalCompras'], 'route' => route('compras.index')],
            ['variant' => 'kpi-danger', 'icon' => 'fa-bullhorn', 'title' => 'Marcas', 'count' => $metricas['totalMarcas'], 'route' => route('marcas.index')],
            ['variant' => 'kpi-info', 'icon' => 'fa-box-archive', 'title' => 'Presentaciones', 'count' => $metricas['totalPresentaciones'], 'route' => route('presentaciones.index')],
            ['variant' => 'kpi-purple', 'icon' => 'fa-cubes', 'title' => 'Productos', 'count' => $metricas['totalProductos'], 'route' => route('productos.index')],
            ['variant' => 'kpi-orange', 'icon' => 'fa-truck-field', 'title' => 'Proveedores', 'count' => $metricas['totalProveedores'], 'route' => route('proveedores.index')],
            ['variant' => 'kpi-teal', 'icon' => 'fa-users-gear', 'title' => 'Usuarios', 'count' => $metricas['totalUsuarios'], 'route' => route('users.index')],
        ];
    @endphp
