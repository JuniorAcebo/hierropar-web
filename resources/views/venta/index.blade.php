...
@section('content')
    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="card-clean">
                                    ...
                                    <td>
                                        <div class="venta-info">
                                            ...
                                            <div>
                                                ...
                                                <span class="info-subtext">N°: {{ $venta->numero_comprobante }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content modal-content-clean">
                                            ...
                                            <div class="modal-body p-4 text-center">
                                                ...
                                                <p class="text-muted small mb-4">Se eliminará el registro de venta y se devolverá el stock a los almacenes correspondientes.</p>
            ...
            <!-- Modal de Exportación Genérico (ACTUALIZADO) -->
                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="alert alert-success border-0 bg-success bg-opacity-10 d-flex align-items-center mb-4" id="exportAlert" style="border-radius: 12px;">
                                ...
                                <div class="small fw-medium text-success">
                                    Se exportarán <strong id="exportCountDisplay">0</strong> ventas seleccionadas.
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label d-block" for="modalIncludeClient">
                                        <span class="d-block fw-semibold small">Incluir información del cliente</span>
...
<script>
    ...
    // Sistema de selección (igual que Productos)
    ...
    // Exportación con rutas genéricas (usando tu sistema de exportación)
    document.addEventListener('click', function(e) {
        if (e.target && e.target.id === 'confirmExportBtn') {
            ...
            form.method = 'POST';
            // Usando tu sistema de rutas genérico
    ...
    // View Modal Logic (mantenido de tu código original)
    ...
    function loadVentaDetails(ventaId) {
        ...
        .then(data => {
            if (data.success) {
                ...
                pdfButton.href = `/ventas/pdf/${ventaId}`;
            } else {
    ...
    function updateSaleStatus(ventaId, type, status) {
        const url = type === 'pago' ? `/ventas/${ventaId}/estado-pago` : `/ventas/${ventaId}/estado-entrega`;
