...
<div class="container-fluid px-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('roles.update',['role'=>$role]) }}" method="post" class="form-container">
                @method('PATCH')
                @csrf
                    ...
                    <div class="permisos-container">
                        ...
                        <div class="permiso-item">
                            <div class="form-check">
                                <input type="checkbox" name="permission[]" id="permiso-{{$item->id}}"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Puedes añadir aquí funcionalidad adicional si es necesario
    });
</script>
@endpush
