...
<body>
    <div class="overlay">
        ...
        <nav class="navbar navbar-expand-md shadow-sm">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">HierroPar</a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="/assets/img/lapacho.jpg"
                        class="img-fluid rounded shadow-sm" alt="HierroPar - Madera">
                </div>
                <!-- Texto -->
                <div class="col-md-6">
                    <h2 class="fw-bold mb-3">¿Quiénes somos?</h2>
                    <p class="mb-3 text-muted">
                        En <strong>HierroPar</strong> combinamos la nobleza de la madera.
    ...
    <!-- Footer -->
    <footer>
        © {{ date('Y') }} HierroPar – Hecho con ❤️ para carpinteros
    </footer>
