...
<style>
    ...
    /* Animacion para mostrar/ocultar */
    .fade-in {
...
<div class="container-fluid px-3 px-md-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Crear Proveedor</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-12" id="box-razon-social">
                    ...
                    <input required type="text" name="razon_social" id="razon_social" class="form-control"
                           value="{{ old('razon_social') }}" placeholder="Ingrese la informacion correspondiente">
                ...
                <div class="col-12">
                    ...
                    <input required type="text" name="direccion" id="direccion" class="form-control"
                           value="{{ old('direccion') }}" placeholder="Ingrese la direccion completa">
                    @error('direccion')
                    <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
    ...
    $(document).ready(function() {
        ...
        $('#tipo_persona').on('change', function() {
            ...
            if (selectValue == 'natural') {
                ...
                $('#razon_social').attr('placeholder', 'Ej: Juan Perez Lopez - Proveedor');
            } else if (selectValue == 'juridica') {
                $('#label-natural').hide();
                $('#label-juridica').show().addClass('fade-in');
                $('#razon_social').attr('placeholder', 'Ej: Empresa XYZ S.A.C. - Proveedores');
            }
        ...
        $('.form-control, .form-select').on('focus', function() {
            ...
            $(this).css('boxShadow', '0 0 0 3px rgba(52, 152, 219, 0.2)');
        }).on('blur', function() {
            $(this).css('transform', 'translateY(0)');
            $(this).css('boxShadow', '0 0 0 3px rgba(52, 152, 219, 0.1)');
        });

        // Si hay valores antiguos, mostrar el campo correspondiente
        @if(old('tipo_persona'))
