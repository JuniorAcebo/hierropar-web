                                    ...
                                    <td>
                                        <div class="compra-info">
                                            ...
                                            <div>
                                                ...
                                                <span class="info-subtext">N°: {{ $item->numero_comprobante }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
...
<script>
    ...
    // NUEVO: Eventos de búsqueda y ordenamiento (igual que Productos)
    ...
    // NUEVO: Función AJAX para actualizar tabla (igual que Productos)
    ...
    // NUEVO: Manejar clic en fila para seleccionar (igual que Productos)
    document.addEventListener('click', function(e) {
    ...
    function updatePurchaseStatus(compraId, type, status) {
        const url = type === 'pago' ? `/compras/${compraId}/estado-pago` : `/compras/${compraId}/estado-entrega`;
