    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                @endcan
                @can('ver-corte-tablero')
                    <a class="nav-link" href="{{ route('cortes-tablero.create') }}"
                        style="padding: 0.6rem 0.8rem; margin: 0.1rem 0.3rem;">
                        <div class="sb-nav-link-icon" style="font-size: 0.9rem;"><i class="fas fa-cut"></i></div>
                        Cortes Tablero
                        <span class="sb-nav-link-badge" style="font-size: 0.6rem; padding: 0.1rem 0.3rem;">Cortes</span>
                    </a>
                @endcan
                ...
                @can('ver-presentacione')
                    <a class="nav-link" href="{{ route('presentaciones.index') }}"
                        style="padding: 0.6rem 0.8rem; margin: 0.1rem 0.3rem;">
                        <div class="sb-nav-link-icon" style="font-size: 0.9rem;"><i class="fa-solid fa-box-open"></i>
                        </div>
                        Presentaciones
                        <span class="sb-nav-link-badge" style="font-size: 0.6rem; padding: 0.1rem 0.3rem;">Pres</span>
                    </a>
                @endcan
