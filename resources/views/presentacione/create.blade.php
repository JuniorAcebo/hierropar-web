...
@section('content')
    <div class="container-fluid px-3 px-md-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">Crear Presentacion</h1>
            <a href="{{ route('presentaciones.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="form-container">
            <form action="{{ route('presentaciones.store') }}" method="post">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label for="nombre" class="form-label">Nombre de la presentación:</label>
                        <input type="text" name="nombre" id="nombre" class="form-control"
                            value="{{ old('nombre') }}"placeholder="Ingrese el nombre de la Presentación">
                        @error('nombre')
