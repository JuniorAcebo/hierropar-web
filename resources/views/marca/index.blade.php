                            ...
                            <div class="action-btns">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        @can('editar-marca')
                                        <li>
                                            <a class="dropdown-item" href="{{route('marcas.edit',['marca'=>$item])}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {{ $item->caracteristica->estado == 1 ? '¿Seguro que quieres eliminar esta marca?' : '¿Seguro que quieres restaurar esta marca?' }}
                                </div>
