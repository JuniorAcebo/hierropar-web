...
<body>
    <table class="header-table">
        <tr>
            <td width="60%">
                ...
                <div style="font-size:10px;">Sistema de Gestión de Inventario</div>
            </td>
    ...
    <div class="footer-note">
        Usuario: {{ auth()->user()->name }} | Página: {PAGINA_ACTUAL} de {TOTAL_PAGINAS} | Generado: {{ now()->format('d/m/Y H:i:s') }}
    </div>
</body>
</html>
